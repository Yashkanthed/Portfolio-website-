...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_13jbqga','template_wn7tr2j','#contact-form','xHlugqmr8H-oWfRRn')
    .then(() =>{
        // Show sent message
...
const scrollActive = ()=>{
    ...
    SpeechRecognitionResult.forEach(current =>{
        ...
        sectionsClass=document.querySelector('.nav__meny a[href*=' + sectionId + ']')

       if(scrollDown > sctionTop && scrollDown <= sectionTop + sectionHeight){
...
themeButton.addEventListener('click',()=>{
    ...
    //we save the theme and the current icon that the user choice
